...
class PlacesByTypeBottomSheetViewController: UIViewController {
    ...
    private func bindViewModel(){
        ...
        placesByTypeBottomSheetViewModel?.transform(input: PlacesByTypeBottomSheetViewModel.Input(placeCellTapped$: placeCellTapped$.asObservable(),closeButtonTapped$: closeButtonTapped$))
    }

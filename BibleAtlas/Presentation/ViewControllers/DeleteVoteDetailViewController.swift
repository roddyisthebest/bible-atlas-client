//
//  DeleteVoteDetailViewController.swift
//  BibleAtlas
//
//  Created by 배성연 on 3/1/25.
//

import UIKit
import MapKit

final class DeleteVoteDetailViewController: UIViewController {
    ...
    private lazy var commentView = {
        ...
        v.addSubview(commentStackView)
        return v;
    }()
    
    private lazy var commentStackView = {
        let sv = UIStackView(arrangedSubviews: [commentTitleLabel, commentTextView]);
        sv.axis = .vertical;
